...
export class GovtAPIClient {
   ...
   * @param query.max_results - Query parameter: max_results (optional)
   * @param query.radius - Query parameter: radius (optional)
   * @param query.geometry - Query parameter: geometry (optional)
   * @param query.with_field_names - Query parameter: with_field_names (optional)
  ...
  >(
    query: { key: string; layer: number; x: string; y: string; max_results?: number; radius?: number; geometry?: boolean; with_field_names?: boolean }
    ...
    if (query) {
      ...
      if (query.max_results !== undefined) searchParams.set('max_results', String(query.max_results));
      if (query.radius !== undefined) searchParams.set('radius', String(query.radius));
      if (query.geometry !== undefined) searchParams.set('geometry', String(query.geometry));
      if (query.with_field_names !== undefined) searchParams.set('with_field_names', String(query.with_field_names));
    }
